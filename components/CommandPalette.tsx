	...
	const items: Array<{
		...
		const actions: Array<{
		...
		}> = [
			{
				key: "new",
				kind: "action",
				title: t("palette_newSession"),
				run: onNewSession,
			},
			{
				key: "theme",
				kind: "action",
				title: t("palette_toggleTheme"),
				run: onToggleTheme,
			},
			{
				key: "set-models",
				kind: "action",
				title: t("palette_settingsModels"),
				run: () => onOpenSettings("models"),
			},
			{
				key: "set-skills",
				kind: "action",
				title: t("palette_settingsSkills"),
				run: () => onOpenSettings("skills"),
			},
			{
				key: "set-plugins",
				kind: "action",
