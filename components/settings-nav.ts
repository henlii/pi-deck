...
export type SettingsPageId = "appearance" | "models" | "defaults" | "skills" | "plugins" | "trust";
...
// defaults / trust 无 cwd 也可看全局；skills/plugins 需要项目。
const PAGE_ORDER: SettingsPageId[] = ["appearance", "models", "defaults", "skills", "plugins", "trust"];
...
/** 页面清单：appearance/models/trust 无 cwd 可用；skills/plugins 无 cwd 时给出提示。 */
